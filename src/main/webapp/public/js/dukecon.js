...
ko.components.register('header-widget', {
    ...
    template:
        ...
        + '<div class="main-menu">'
        + '<a href="index.html">Talks</a>|<a href="speakers.html">Sprecher</a>|<a href="http://dukecon.org/impressum.html">Impressum</a>'
        + '</div>'
    ...
    template:
        '<div class="talk-cell">'
            + '<div class="title">'
                ...
                + '<i class="fav fa fa-lg" style="cursor:pointer; margin-left: 2px;" title="Add to Favourites" data-bind="click: dukeconSettings.toggleFavourite, css: talk.favclass"></i>'
            + '</div>'
