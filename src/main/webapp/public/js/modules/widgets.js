define(['knockout', 'js/modules/languageutils', 'js/modules/offline', 'js/modules/dukecloak', 'js/modules/dukecon'], function(ko, languageUtils, dukeconTalkUtils, dukecloak, dukecon) {
    ...
    ko.components.register('login-widget', {
        ...
        template:
            ...
            + '         <img data-bind="attr: {src: dukecloak.auth.gravatar}, visible: !hideLoginButton && dukecloak.auth.loggedIn" class="gravatar"/>'
    ...
    ko.components.register('talk-widget', {
        ...
        template:
            ...
            + '<div class="title">'
            + '<img style="cursor:pointer; margin-right: 2px;" title="Add to Favourites" data-bind="click: toggleFavourite, attr:{src: talk.favicon}"/>'
