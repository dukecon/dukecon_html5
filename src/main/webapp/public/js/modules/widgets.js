define(['knockout', 'js/modules/languageutils', 'js/modules/offline', 'js/modules/dukecloak', 'js/modules/dukecon'], function(ko, languageUtils, dukeconTalkUtils, dukecloak, dukecon) {
    ...
    ko.components.register('talk-widget', {
        ...
        template:
            ...
            '       alt="Favorit" data-bind="click: toggleFavourite, clickBubble: false, attr:{src: talk.favicon, title: talk.numberOfFavorites()}"/>'
            ...
            + '  <span data-bind="text: talk.locationDisplay" /> <span>(</span><span data-bind="text: talk.locationCapacity"></span><span>)</span>'
            + ' </div>'
