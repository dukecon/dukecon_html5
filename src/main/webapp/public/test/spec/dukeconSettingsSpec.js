define(['js/modules/dukeconsettings', 'js/modules/synch'], function(dukeconSettings, dukeconSynch){
    describe("dukecon settings", function () {
        it("handle favourites", function () {
            ...
            dukeconSettings.toggleFavourite(talk.talk.id);
        ...
        it("handle filters active", function() {
            ...
            dukeconSettings.saveSetting(dukeconSettings.keys.filter_active_key, false);
            expect(dukeconSettings.filtersActive()).toEqual(false);
            dukeconSettings.saveSetting(dukeconSettings.keys.filter_active_key, true);
            expect(dukeconSettings.filtersActive()).toEqual(true);
        });
    });
});
